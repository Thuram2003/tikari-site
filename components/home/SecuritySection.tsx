    ...
    <section className="w-full py-20 lg:py-28 px-6 bg-white border-b border-tikari-green/10">
      <div className="max-w-7xl mx-auto space-y-14 lg:space-y-16">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-5">
          <div className="inline-flex items-center px-3.5 py-1.5 bg-tikari-gold/10 border border-tikari-gold/30 rounded-full">
            <span className="text-[11px] uppercase tracking-[0.15em] text-tikari-gold-dark font-semibold">
              {t("badge")}
            </span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="relative h-[400px] lg:h-[520px] order-2 lg:order-1">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-tikari-green-dark/90 to-transparent p-6 rounded-b-2xl">
          ...
          <div className="grid gap-5 order-1 lg:order-2">
            {securityItems.map((item, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="p-6 lg:p-7 bg-tikari-cream-light/50 border border-tikari-green/[0.08] rounded-2xl hover:border-tikari-green/[0.15] hover:bg-white transition-all duration-300 flex gap-5 group"
                >
                  {/* Icon */}
                  <div className="w-12 h-12 rounded-full bg-tikari-green/[0.08] border border-tikari-green/[0.12] flex items-center justify-center text-tikari-green shrink-0 group-hover:bg-tikari-green/[0.12] group-hover:border-tikari-green/[0.2] transition-all duration-300">
                    <Icon
                      size={21}
                      weight="regular"
                    />
