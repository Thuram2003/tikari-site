    ...
    <section className="relative w-full min-h-[600px] lg:h-[750px] max-h-[750px] flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20 sm:py-24 lg:py-32">
        <div className="max-w-5xl mx-auto text-center text-white space-y-6 sm:space-y-8 lg:space-y-10">
          ...
          {/* Trust Badges */}
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-6 lg:gap-8 pt-6 sm:pt-8 text-sm sm:text-base">
            <div className="flex items-center gap-2">
              <CheckCircle className="h-5 w-5 sm:h-6 sm:w-6 text-tikari-gold flex-shrink-0" weight="fill" />
              <span className="text-tikari-cream/80">{t("badges.shariah")}</span>
            </div>
